...
View(myers_index_2020_males[2]) # digits concentration
...
View(myers_index_2020_females[2]) # digits concentration
...
View(myers_index_2020_both[2]) # digits concentration
...
View(myers_index_2010_males[2]) # digits concentration
...
View(myers_index_2010_females[2]) # digits concentration
